    ...
    */}
          <div className="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white dark:bg-black rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              ...
              <div className="mt-3 text-center sm:mt-5">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <a
                      href="https://twitter.com/Kali_root_zBUGS"
                      target="_blank"
            ...
            <div className="flex justify-center mx-auto mt-5 sm:mt-6">
              <a href="https://www.buymeacoffee.com/gprakashraj">
                <img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=gprakashraj&button_colour=FFDD00&font_colour=000000&font_family=Cookie&outline_colour=000000&coffee_colour=ffffff" />
              </a>
            </div>
          </div>
        </div>
